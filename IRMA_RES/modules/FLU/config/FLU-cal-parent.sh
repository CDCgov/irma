...
REF_SET=$(dirname $REF_SET)/H3mutualityTest.fasta
ASSEM_REF=1
...
MIN_F=0.0025				# minimum frequency for variants
...
MIN_FA=1
MAX_ROUNDS=1				# maximum rounds for reach gathering
...
# ASSEMBLY
MAX_ITER_SSW=1				# max num of SSW iterations to perform, 3 should be sufficient w/4 to prove
