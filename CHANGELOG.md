...
- Fixes CIGARs in merged reads to reflect the actual hard-clipped bases.

### Changes

- Updated to IRMA-core v0.6.1: preprocess error messages are improved + CIGAR fix above.
- Updated to LABEL v0.7.2: Shogun is now natively compatible with Apple silicon.
...
[1.4.0]: https://github.com/CDCgov/irma/compare/v1.3.5...v1.4.0
